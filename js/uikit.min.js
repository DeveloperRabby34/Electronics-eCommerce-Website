...
! function(t, e) {
    ...
    function S(t) {
        return I(t) && Object.getPrototypeOf(t) === e
    }
    ...
    function j(t) {
        return A(t) || T(t) || E(t) ? t : N(t) || C(t) ? t[0] : k(t) ? j(t[0]) : null
    }

    function W(t) {
        return A(t) ? [t] : N(t) ? m.slice.call(t) : k(t) ? t.map(j).filter(Boolean) : C(t) ? t.toArray() : []
    }
    ...
    function Y(t, n) {
        return t === n || I(t) && I(n) && Object.keys(t).length === Object.keys(n).length && X(t, function(t, e) {
            return t === n[e]
        })
    }
    ...
    function nt(t, e, n) {
        if (I(e))
            for (var i in e) nt(t, i, e[i]);
        else {
            if (P(n)) return (t = j(t)) && t.getAttribute(e);
            W(t).forEach(function(t) {
                $(n) && (n = n.call(t, nt(t, e))), null === n ? rt(t, e) : t.setAttribute(e, n)
            })
        }
    }
    ...
    var st = /msie|trident/i.test(window.navigator.userAgent),
        at = "rtl" === nt(document.documentElement, "dir"),
        ht = "ontouchstart" in window,
        ct = window.PointerEvent,
        ut = ht || window.DocumentTouch && document instanceof DocumentTouch || navigator.maxTouchPoints,
        lt = ct ? "pointerdown" : ht ? "touchstart" : "mousedown",
        dt = ct ? "pointermove" : ht ? "touchmove" : "mousemove",
        ft = ct ? "pointerup" : ht ? "touchend" : "mouseup",
        pt = ct ? "pointerenter" : ht ? "" : "mouseenter",
        mt = ct ? "pointerleave" : ht ? "" : "mouseleave",
        gt = ct ? "pointercancel" : "touchcancel";

    function vt(t, e) {
        return j(t) || yt(t, bt(t, e))
    }

    function wt(t, e) {
        var n = W(t);
        return n.length && n || xt(t, bt(t, e))
    }

    function bt(t, e) {
        return void 0 === e && (e = document), St(t) || E(e) ? e : e.ownerDocument
    }

    function yt(t, e) {
        return j(kt(t, e, "querySelector"))
    }

    function xt(t, e) {
        return W(kt(t, e, "querySelectorAll"))
    }

    function kt(t, s, e) {
        if (void 0 === s && (s = document), !t || !O(t)) return null;
        var a;
        St(t = t.replace(It, "$1 *")) && (a = [], t = function(t) {
            return t.match(Tt).map(function(t) {
            ...
            if ("!" === t[0]) {
                ...
                n = Nt(s.parentNode, i[0]), t = i.slice(1).join(" ").trim()
            }
            if ("-" === t[0]) {
                var r = t.substr(1).trim().split(" "),
                    o = (n || s).previousElementSibling;
                n = At(o, t.substr(1)) ? o : null, t = r.slice(1).join(" ")
            }
    ...
    function St(t) {
        return O(t) && t.match($t)
    }
    var Tt = /.*?[^\\](?:,|$)/g;
    var Et = Element.prototype,
        Ct = Et.matches || Et.webkitMatchesSelector || Et.msMatchesSelector;
    ...
    function Nt(t, e) {
        return w(e, ">") && (e = e.slice(1)), A(t) ? _t.call(t, e) : W(t).map(function(t) {
            return Nt(t, e)
        }).filter(Boolean)
    }
    ...
    function Mt(t, e) {
        var n = [];
        for (t = j(t);
            (t = t.parentNode) && 1 === t.nodeType;) At(t, e) && n.push(t);
        return n
    }
    ...
    function Bt(t) {
        return W(t).some(function(t) {
            return zt[t.tagName.toLowerCase()]
        })
    }
    ...
    var Ht = "input,select,textarea,button";
    ...
    function jt(t, e) {
        return O(e) ? At(t, e) || Nt(t, e) : t === e || (E(e) ? e.documentElement : j(e)).contains(j(t))
    }
    ...
    function Wt() {
        ...
        var n = Ut(t),
            ...
            s = n[3],
            a = n[4];
        return i = Jt(i), 1 < s.length && (s = function(e) {
                return function(t) {
                ...
                return function(n) {
                    t.forEach(function(t) {
                        var e = ">" === i[0] ? xt(i, t).reverse().filter(function(t) {
                            return jt(n.target, t)
                        })[0] : Nt(n.target, i);
                        e && (n.delegate = t, n.current = e, r.call(o, n))
                    })
                }
            }(i, o, s)), a && a.self && (s = function(e) {
                return function(t) {
                    if (t.target === t.currentTarget || t.target === t.current) return e.call(null, t)
                }
            }(s)), a = Xt(a), r.split(" ").forEach(function(e) {
    ...
    function Vt(t, e, n, i) {
        void 0 === i && (i = !1), i = Xt(i), t = Jt(t), e.split(" ").forEach(function(e) {
            return t.forEach(function(t) {
    ...
    function Yt(t, n, i) {
        return Jt(t).reduce(function(t, e) {
            return t && e.dispatchEvent(qt(n, !0, !0, i))
        }, !0)
    }
    ...
    function Jt(t) {
        return k(t) ? t.map(Gt).filter(Boolean) : O(t) ? xt(t) : Kt(t) ? [t] : W(t)
    }
    ...
    function te() {
        var n = this;
        this.promise = new ee(function(t, e) {
            n.reject = e, n.resolve = t
        })
    }
    var ee = "Promise" in window ? window.Promise : re,
        ne = 2,
        ie = "setImmediate" in window ? setImmediate : setTimeout;

    function re(t) {
        this.state = ne, this.value = void 0, this.deferred = [];
        var e = this;
        try {
            t(function(t) {
                e.resolve(t)
    ...
    re.reject = function(n) {
        return new re(function(t, e) {
            e(n)
        })
    }, re.resolve = function(n) {
        return new re(function(t, e) {
            t(n)
        })
    }, re.all = function(s) {
        return new re(function(n, t) {
            var i = [],
                r = 0;
            ...
            0 === s.length && n(i);
            for (var o = 0; o < s.length; o += 1) re.resolve(s[o]).then(e(o), t)
        })
    }, re.race = function(i) {
        return new re(function(t, e) {
            for (var n = 0; n < i.length; n += 1) re.resolve(i[n]).then(t, e)
        })
    };
    var oe = re.prototype;
    ...
    function ue(t, e, n, i) {
        ...
        var r = (e = W(e)).length;
        return t = z(t) ? L(t) : "next" === t ? n + 1 : "previous" === t ? n - 1 : ce(e, t), i ? J(t, 0, r - 1) : (t %= r) < 0 ? t + r : t
    }
    ...
    function de(t, e) {
        return t = Se(t), P(e) ? t.innerHTML : fe(t.hasChildNodes() ? le(t) : t, e)
    }
    ...
    function ge(t, e) {
        return (t = O(t) ? $e(t) : t) ? "length" in t ? W(t).map(e) : e(t) : null
    }
    ...
    function we(t, e) {
        for (e = j(pe(t, e)); e.firstChild;) e = e.firstChild;
        return fe(e, t), e
    }

    function be(t, e) {
        return W(W(t).map(function(t) {
            return t.hasChildNodes ? we(W(t.childNodes), e) : fe(t, e)
        }))
    }
    ...
    function $e(t) {
        ...
        return xe.test(t) ? n.insertAdjacentHTML("beforeend", t.trim()) : n.textContent = t, 1 < n.childNodes.length ? W(n.childNodes) : n.firstChild
    }
    ...
    function Se(t, e) {
        return O(t) ? Ee(t) ? j($e(t)) : yt(t, e) : j(t)
    }

    function Te(t, e) {
        return O(t) ? Ee(t) ? W($e(t)) : xt(t, e) : W(t)
    }
    ...
    function Oe(t) {
        ...
        if (i.length) {
            var r = O((i = ze(i))[i.length - 1]) ? [] : i.pop();
            i = i.filter(Boolean), W(t).forEach(function(t) {
                for (var e = t.classList, n = 0; n < i.length; n++) Be.Force ? e.toggle.apply(e, [i[n]].concat(r)) : e[(P(r) ? !e.contains(i[n]) : r) ? "add" : "remove"](i[n])
            })
        }
    }

    function De(t, n, i) {
        (n = ze(n).filter(Boolean)).length && W(t).forEach(function(t) {
            var e = t.classList;
            Be.Multiple ? e[i].apply(e, n) : n.forEach(function(t) {
                return e[i](t)
            })
        })
    }
    ...
    function He(t, e, r) {
        return W(t).map(function(n) {
            if (O(e)) {
                if (e = Re(e), P(r)) return Fe(n, e);
                r || D(r) ? n.style[e] = z(r) && !Pe[e] ? r + "px" : r : n.style.removeProperty(e)
            } else {
                if (k(e)) {
                    var i = Le(n);
    ...
    function We(t) {
        ...
        if (!st) return Le(e).getPropertyValue("--uk-" + t);
        if (!(t in je)) {
            var n = fe(e, document.createElement("div"));
            Ce(n, "uk-" + t), je[t] = Fe(n, "content", ":before").replace(/^["'](.*)["']$/, "$1"), ve(n)
        }
        return je[t]
    }
    var Ve = {};
    ...
    function Re(t) {
        ...
        return e = e || (Ve[t] = function(t) {
            ...
            var n, i = Ye.length;
            for (; i--;)
                if ((n = "-" + Ye[i] + "-" + t) in e) return n
        }(t) || t)
    }
    var Ye = ["webkit", "moz", "ms"];

    function qe(t, s, a, h) {
        return void 0 === a && (a = 400), void 0 === h && (h = "linear"), ee.all(W(t).map(function(o) {
            return new ee(function(n, i) {
                ...
                var r = setTimeout(function() {
                    return Yt(o, "transitionend")
                }, a);
                Rt(o, "transitionend transitioncanceled", function(t) {
                    var e = t.type;
                    clearTimeout(r), Ae(o, "uk-transition"), He(o, {
                        "transition-property": "",
                        "transition-duration": "",
    ...
    var Ue = {
            start: qe,
            stop: function(t) {
                return Yt(t, "transitionend"), ee.resolve()
            },
            cancel: function(t) {
    ...
    function Ge(t, e, n, a, h) {
        var c = arguments;
        return void 0 === n && (n = 200), ee.all(W(t).map(function(s) {
            return new ee(function(i, r) {
                if (Me(s, Ke)) requestAnimationFrame(function() {
                    ...
                    w(e, Xe) && (a && (t += " uk-transform-origin-" + a), h && (t += " " + Xe + "reverse")), o(), Rt(s, "animationend animationcancel", function(t) {
                        var e = t.type,
                            n = !1;
                        "animationcancel" === e ? (r(), o()) : (i(), ee.resolve().then(function() {
                            n = !0, o()
                        })), requestAnimationFrame(function() {
                            n || (Ce(s, Ke), requestAnimationFrame(function() {
                                return Ae(s, Ke)
                            }))
                        })
                    }, {
                        self: !0
                    }), He(s, "animationDuration", n + "ms"), Ce(s, t)
                }

                function o() {
                    He(s, "animationDuration", ""), _e(s, Xe + "\\S*")
                }
            })
        }))
    }
    var Je = new RegExp(Xe + "(enter|leave)"),
        Ze = { in: function(t, e, n, i) {
                return Ge(t, e, n, i, !1)
            },
    ...
    function tn(t, e, u, l, d, n, i, r) {
        ...
        if (cn(g, u, p, -1), cn(g, l, m, 1), d = ln(d, p.width, p.height), n = ln(n, m.width, m.height), d.x += n.x, d.y += n.y, g.left += d.x, g.top += d.y, i) {
            var o = [nn(bn(t))];
            r && o.unshift(nn(r)), X(Qe, function(t, s) {
                var a = t[0],
                    h = t[1],
                    c = t[2];
    ...
    function en(n, i) {
        if (n = j(n), !i) return nn(n);
        var r = en(n),
            o = He(n, "position");
        ["left", "top"].forEach(function(t) {
            if (t in i) {
                var e = He(n, t);
                He(n, t, i[t] - r[t] + F("absolute" === o && "auto" === e ? rn(n)[t] : e))
            }
        })
    }
    ...
    function nn(t) {
        ...
        Pt(t) || "none" !== He(t, "display") || (e = nt(t, "style"), n = nt(t, "hidden"), nt(t, {
    ...
    function rn(i) {
        var r = (i = j(i)).offsetParent || function(t) {
            ...
            t = ["top", "left"].reduce(function(t, e) {
                var n = p(e);
                return t[e] -= o[e] + F(He(i, "margin" + n)) + F(He(r, "border" + n + "Width")), t
            }, en(i));
        return {
            top: t.top,
            left: t.left
    ...
    function an(i) {
        ...
        return function(t, e) {
            if (t = j(t), P(e)) {
                ...
                return (e = "auto" === (e = He(t, i)) ? t["offset" + r] : F(e) || 0) - hn(i, t)
            }
    ...
    function hn(t, n, e) {
        return void 0 === e && (e = "border-box"), He(n, "boxSizing") === e ? Qe[t].slice(1).map(p).reduce(function(t, e) {
            return t + F(He(n, "padding" + e)) + F(He(n, "border" + e + "Width"))
        }, 0) : 0
    }
    ...
    function fn(t, e, n) {
        if (void 0 === e && (e = 0), void 0 === n && (n = 0), !Pt(t)) return !1;
        var i = bn(t = j(t)),
    ...
    function pn(t, e) {
        ...
        return J((a + n.pageYOffset - o) / ((a + (r - (h < s ? h : 0))) / 100) / 100)
    }
    ...
    function vn(t, e, n) {
        return void 0 === e && (e = "width"), void 0 === n && (n = window), z(t) ? +t : u(t, "vh") ? wn(on(bn(n)), t) : u(t, "vw") ? wn(sn(bn(n)), t) : u(t, "%") ? wn(nn(n)[e], t) : F(t)
    }
    ...
    function $n(t) {
        void 0 === t && (t = !1), xn.scheduled || (xn.scheduled = !0, t ? ee.resolve().then(kn) : requestAnimationFrame(kn))
    }
    ...
    Tn.prototype = {
        ...
        init: function() {
            ...
            var r = !1;
            this.unbind = Wt(document, "mousemove", function(n) {
    ...
    function An(t, e, n) {
        return Cn.computed($(t) ? t.call(n, n) : t, $(e) ? e.call(n, n) : e)
    }
    ...
    Cn.events = Cn.created = Cn.beforeConnect = Cn.connected = Cn.beforeDisconnect = Cn.disconnected = Cn.destroy = _n, Cn.args = function(t, e) {
        return !1 !== e && _n(e || t)
    }, Cn.update = function(t, e) {
        return K(_n(t, $(e) ? {
            read: e
        } : e), "order")
    }, Cn.props = function(t, e) {
        return k(e) && (e = e.reduce(function(t, e) {
            return t[e] = String, t
        }, {})), Cn.methods(t, e)
    }, Cn.computed = Cn.methods = function(t, e) {
        return e ? t ? U({}, t, e) : e : t
    }, Cn.data = function(e, n, t) {
    ...
    On.prototype.isVideo = function() {
        ...
        var n, i = this.isYoutube(),
            r = this.isVimeo();
        return i || r ? this.ready = new ee(function(t) {
            Rt(e.el, "load", function() {
                    if (i) {
                        var t = function() {
                            return zn(e.el, {
                                event: "listening",
                ...
                function(i) {
                    return new ee(function(n) {
                        Rt(window, "message", function(t, e) {
                            return n(e)
                        }, !1, function(t) {
                            var e = t.data;
                            if (e && O(e)) {
                    ...
                    t(), n && clearInterval(n)
                }), nt(e.el, "src", e.el.src + (b(e.el.src, "?") ? "&" : "?") + (i ? "enablejsapi=1" : "api=1&player_id=" + e.id))
        }) : ee.resolve()
        ...
        }) : this.isHTML5() && (this.el.muted = !0, nt(this.el, "muted", "")))
    };
    ...
    var Ln, Fn, jn, Wn, Vn, Rn, Yn, qn, Un;
    ...
    function Jn(e, n, i) {
        ...
        }) : !r || c && !c.call(e) || e._events.push(Wt(r, t, h ? O(h) ? h : h.call(e) : null, O(o) ? e[o] : o.bind(e), {
            passive: a,
            capture: s,
            self: u
        }))
    ...
    Hn.util = Object.freeze({
            ...
            (e = (O(e) ? Ln.component(e) : e) || this).options = Nn(e.options, t)
            ...
            e && e.forEach(function(t, e) {
                var n = t.read,
                    i = t.write,
                    r = t.events;
                "update" !== s && !b(r, s) || (n && !b(xn.reads, a[e]) && (a[e] = xn.read(function() {
                    var t = o._connected && n.call(o, o._data, s);
                    !1 === t && i ? xn.clear(h[e]) : S(t) && U(o._data, t)
                })), i && !b(xn.writes, h[e]) && (h[e] = xn.write(function() {
                    return o._connected && i.call(o, o._data, s)
                })))
            })
        }, Rn = 0, (Vn = Hn).prototype._init = function(t) {
            (t = t || {}).data = function(t, e) {
                var n = t.data,
                    i = (t.el, e.args),
                    r = e.props;
                if (void 0 === r && (r = {}), n = k(n) ? B(i) ? void 0 : n.slice(0, i.length).reduce(function(t, e, n) {
                        return S(e) ? U(t, e) : t[i[n]] = e, t
                    }, {}) : n)
                    for (var o in n) P(n[o]) ? delete n[o] : n[o] = r[o] ? Qn(r[o], n[o]) : n[o];
                return n
            }(t, this.constructor.options), this.$options = Nn(this.constructor.options, t, this), this.$el = null, this.$props = {}, this._frames = {
                reads: {},
                writes: {}
            }, this._events = [], this._uid = Rn++, this._initData(), this._initMethods(), this._initComputeds(), this._callHook("created"), t.el && this.$mount(t.el)
            ...
            var e;
            for (e in t = t || Kn(this.$options, this.$name)) P(t[e]) || (this.$props[e] = t[e]);
        ...
        }, qn = (Yn = Hn).data, Un = {}, Yn.component = function(s, t) {
            if (!t) return S(Un[s]) && (Un[s] = Yn.extend(Un[s])), Un[s];
            Yn[s] = function(t, n) {
        ...
        function(i) {
            ...
            i.prototype.$mount = function(t) {
                ...
                t[r] || (t[r] = {}), t[r][e] || ((t[r][e] = this).$el = this.$options.el = this.$options.el || t, jt(t, document) && this._callConnected())
                ...
                var e = this.$options,
                    n = e.el,
                    i = e.name;
                n && this._callDisconnected(), this._callHook("destroy"), n && n[r] && (delete n[r][i], B(n[r]) || delete n[r], t && ve(this.$el))
    ...
    var ti = {
            connected: function() {
                Me(this.$el, this.$name) || Ce(this.$el, this.$name)
            }
        },
        ei = {
            props: {
            ...
            methods: {
                toggleElement: function(c, u, l) {
                    ...
                    return new ee(function(t) {
                        ...
                        function e(t) {
                            return ee.all(t.map(function(t) {
                ...
                toggleNow: function(e, n) {
                    var i = this;
                    return new ee(function(t) {
                        return ee.all(W(e).map(function(t) {
                ...
                isToggled: function(t) {
                    var e = W(t || this.$el);
                    return this.cls ? Me(e, this.cls.split(" ")[0]) : !it(e, "hidden")
                },
                ...
                _toggleElement: function(t, e, n) {
                    var i = this;
                    if (e = M(e) ? e : Ze.inProgress(t) ? Me(t, "uk-animation-leave") : Ue.inProgress(t) ? "0px" === t.style.height : !this.isToggled(t), !Yt(t, "before" + (e ? "show" : "hide"), [this])) return ee.reject();
                    var r = ($(n) ? n : !1 !== n && this.hasAnimation ? this.hasTransition ? function(t) {
                        ...
                        return function(t, e) {
                            var n = Ue.inProgress(t),
                                i = t.hasChildNodes ? F(He(t.firstElementChild, "marginTop")) + F(He(t.lastElementChild, "marginBottom")) : 0,
                                r = Pt(t) ? on(t) + (n ? 0 : i) : 0;
                            Ue.cancel(t), s(t) || l(t, !0), on(t, ""), xn.flush();
                            var o = on(t) + (n ? 0 : i);
                            return on(t, r), (e ? Ue.start(t, U({}, h, {
                                overflow: "hidden",
                                height: o
                    ...
                    function o() {
                        Yt(t, e ? "shown" : "hidden", [i]), i.$update(t)
                    }
                    return r ? r.then(o) : ee.resolve(o())
                },
                _toggle: function(t, e) {
                    var n;
                    t && (e = Boolean(e), this.cls ? (n = b(this.cls, " ") || e !== Me(t, this.cls)) && Oe(t, this.cls, b(this.cls, " ") ? void 0 : e) : (n = e === it(t, "hidden")) && nt(t, "hidden", e ? null : ""), Te("[autofocus]", t).some(function(t) {
                        return Pt(t) ? t.focus() || !0 : t.blur()
                ...
                toggle: function(r, o) {
                    ...
                    (r = this.items[t]) && [r].concat(!this.multiple && !b(a, r) && a || []).forEach(function(t) {
                        ...
                        if (n || !e || s.collapsible || !(a.length < 2)) {
                            ...
                            t._wrapper || (t._wrapper = we(i, "<div>"), nt(t._wrapper, "hidden", n ? "" : null)), s._toggle(i, !0), s.toggleElement(t._wrapper, n, o).then(function() {
    ...
    function ri(r) {
        he(function() {
            var n;
            r.update(), Wt(window, "load resize", function() {
                return r.update(null, "resize")
            }), Wt(document, "loadedmetadata load", function(t) {
                var e = t.target;
                return r.update(e, "resize")
            }, !0), Wt(window, "scroll", function(t) {
                if (!n) {
            ...
            }, !0), Wt(document, lt, function(t) {
                if (e && e(), Zt(t)) {
                    var r = Qt(t),
                        o = "tagName" in t.target ? t.target : t.target.parentNode;
                    e = Rt(document, ft + " " + gt, function(t) {
                        var e = Qt(t),
                            n = e.x,
                            i = e.y;
                        (o && n && 100 < Math.abs(r.x - n) || i && 100 < Math.abs(r.y - i)) && setTimeout(function() {
                            Yt(o, "swipe"), Yt(o, "swipe" + function(t, e, n, i) {
                                return Math.abs(t - n) >= Math.abs(e - i) ? 0 < t - n ? "Left" : "Right" : 0 < e - i ? "Up" : "Down"
                            }(r.x, r.y, n, i))
                        })
                    }), "touchstart" === lt && (He(document.body, "cursor", "pointer"), Rt(document, ft + " " + gt, function() {
                        return setTimeout(function() {
                            return He(document.body, "cursor", "")
                        }, 50)
                    }))
                }
            }, {
    ...
    var oi, si = {
            ...
            connected: function() {
                this.inView && !it(this.$el, "preload") && (this.$el.preload = "none"), this.player = new On(this.$el), this.automute && this.player.mute()
            },
            update: {
                read: function() {
                    return !!this.player && {
                        visible: Pt(this.$el) && "hidden" !== He(this.$el, "visibility"),
        ...
        hi = {
            ...
            methods: {
                positionAt: function(t, e, n) {
                    var i;
                    _e(t, this.clsPos + "-(top|bottom|left|right)(-[a-z]+)?"), He(t, {
                        top: "",
                        left: ""
                    });
                    var r = this.offset,
        ...
        ci = {
            ...
            events: [{
                ...
                handler: function(t) {
                    Zt(t) || (oi && oi !== this && oi.toggle && b(oi.toggle.mode, "hover") && !jt(t.target, oi.toggle.$el) && !tt({
                        x: t.pageX,
                        y: t.pageY
                ...
                name: "togglehide " + mt,
                handler: function(t, e) {
                    Zt(t) || e && !b(e.target, this.$el) || (t.preventDefault(), this.toggle && b(this.toggle.mode, "hover") && this.hide())
                }
            }, {
                name: "beforeshow",
                self: !0,
                ...
                handler: function() {
                    var i = this;
                    this.tracker.init(), Yt(this.$el, "updatearia");
                    var t = ui(document, "click", function(t) {
                        var e = t.defaultPrevented,
                            n = t.target;
                        e || jt(n, i.$el) || i.toggle && jt(n, i.toggle.$el) || i.hide(!1)
                    });
                    Rt(this.$el, "hide", t, {
                        self: !0
                    })
                ...
                handler: function(t) {
                    var e = t.target;
                    this.$el === e ? (oi = this.isActive() ? null : oi, Yt(this.$el, "updatearia"), this.tracker.cancel()) : oi = null === oi && jt(e, this.$el) && this.isToggled() ? this : oi
                }
            }, {
                name: "updatearia",
                self: !0,
                handler: function(t, e) {
                    t.preventDefault(), this.updateAria(this.$el), (e || this.toggle) && (nt((e || this.toggle).$el, "aria-expanded", this.isToggled()), Oe(this.toggle.$el, this.cls, this.isToggled()))
                }
            }],
            update: {
                write: function() {
            ...
            methods: {
                show: function(e, n) {
                        ...
                        if (i.toggle = e || i.toggle, i.clearTimers(), !i.isActive())
                            if (n && oi && oi !== i && oi.isDelaying) i.showTimer = setTimeout(i.show, 10);
                                ...
                                if (i.isParentOf(oi)) {
                                    ...
                                    oi.hide(!1)
                                } else if (i.isChildOf(oi)) oi.clearTimers();
                    ...
                    e && this.toggle && e.$el !== this.toggle.$el ? (Rt(this.$el, "hide", t), this.hide(!1)) : t()
                },
                hide: function(t) {
                    var e = this;
                    void 0 === t && (t = !0);
                ...
                position: function() {
                    _e(this.$el, this.clsDrop + "-(stack|boundary)"), He(this.$el, {
                        top: "",
                        left: "",
                        display: "block"
                    ...
                    if ("justify" === this.align) {
                        ...
                        He(this.$el, n, e[n])
                    } else this.$el.offsetWidth > Math.max(t.right - e.left, e.right - t.left) && Ce(this.$el, this.clsDrop + "-stack");
    ...
    var li = {
        ...
        di = {
            ...
            computed: {
                ...
                target: function(t, e) {
                    var n = t.target;
                    return n && (!0 === n && this.input.parentNode === e && this.input.nextElementSibling || vt(n, e))
                }
            },
            update: function() {
                var t = this.target,
                    e = this.input;
                if (t) {
                    var n, i = Lt(t) ? "value" : "textContent",
                        r = t[i],
                        o = e.files && e.files[0] ? e.files[0].name : At(e, "select") && (n = Te("option", e).filter(function(t) {
                            return t.selected
        ...
        pi = {
            ...
            update: {
                read: function(t) {
                    ...
                    if (!e.length || !Pt(this.$el)) return t.rows = [
                        []
                    ];
        ...
        for (var e = [
            ...
            if (r.height)
                for (var o = e.length - 1; 0 <= o; o--) {
                    ...
                    var a = void 0;
                    if (a = s[0].offsetParent === i.offsetParent ? gi(s[0]) : (r = gi(i, !0), gi(s[0], !0)), r.top >= a.bottom - 1 && r.top !== a.top) {
                        e.push([i]);
                        break
                    }
                    if (r.bottom > a.top) {
    ...
    var vi = {
        ...
        connected: function() {
            this.masonry && Ce(this.$el, "uk-flex-top uk-flex-wrap-top")
        },
        update: [{
            read: function(t) {
                var r = t.rows;
                (this.masonry || this.parallax) && (r = r.map(function(t) {
                    return K(t, "offsetLeft")
                }), at && r.map(function(t) {
                    return t.reverse()
                }));
                ...
                if (this.masonry && this.length) {
                    ...
                    n = r.reduce(function(n, t, i) {
                        ...
                        return F(i ? He(i, "marginTop") : He(n[0], "paddingLeft"))
            ...
            write: function(t) {
                var e = t.stacks,
                    n = t.height,
                    i = t.padding;
                Oe(this.$el, this.clsStack, e), He(this.$el, "paddingBottom", i), !1 !== n && He(this.$el, "height", n)
            },
            events: ["resize"]
        }, {
            read: function(t) {
    ...
    var ki = {
        ...
        update: {
            read: function(t) {
                var e = t.minHeight;
                if (!Pt(this.$el)) return !1;
                var n = "",
                    i = hn("height", this.$el, "content-box");
                if (this.expand) {
                    if (this.$el.dataset.heightExpand = "", Se("[data-height-expand]") !== this.$el) return !1;
                    n = on(window) - ($i(document.documentElement) - $i(this.$el)) - i || ""
                } else {
                    if (n = "calc(100vh", this.offsetTop) {
                        var r = en(this.$el).top;
                        n += 0 < r && r < on(window) / 2 ? " - " + r + "px" : ""
                    }!0 === this.offsetBottom ? n += " - " + $i(this.$el.nextElementSibling) + "px" : z(this.offsetBottom) ? n += " - " + this.offsetBottom + "vh" : this.offsetBottom && u(this.offsetBottom, "px") ? n += " - " + F(this.offsetBottom) + "px" : O(this.offsetBottom) && (n += " - " + $i(vt(this.offsetBottom, this.$el)) + "px"), n += (i ? " - " + i + "px" : "") + ")"
                }
                return {
                    minHeight: n,
                    prev: e
            ...
            write: function(t) {
                ...
                He(this.$el, {
                    minHeight: e
                }), e !== n && this.$update(this.$el, "resize"), this.minHeight && F(He(this.$el, "minHeight")) < this.minHeight && He(this.$el, "minHeight", this.minHeight)
            },
            events: ["resize"]
        }
    };
    ...
    var Ii = {
            ...
            disconnected: function() {
                var e = this;
                Bt(this.$el) && nt(this.$el, "hidden", null), this.svg && this.svg.then(function(t) {
                    return (!e._connected || t !== e.svgEl) && ve(t)
                }, Z), this.svg = this.svgEl = null
            },
            update: {
                read: function() {
                    return !!(this.strokeAnimation && this.svgEl && Pt(this.svgEl))
                },
                write: function() {
                    ! function(t) {
                        var e = Ci(t);
            ...
            methods: {
                getSvg: function() {
                    ...
                    return function(n) {
                        if (Si[n]) return Si[n];
                        return Si[n] = new ee(function(e, t) {
                            n ? w(n, "data:") ? e(decodeURIComponent(n.split(",")[1])) : se(n).then(function(t) {
                                return e(t.response)
                            }, function() {
                        ...
                        }(t, e.icon) || ee.reject("SVG not found.")
                    })
                },
                applyAttributes: function(n) {
                    var i = this;
                    for (var t in this.$options.props) this[t] && b(this.include, t) && nt(n, t, this[t]);
                    ...
                    c && !h.some(function(t) {
                        ...
                        (t = (0 | t) * i.ratio) && nt(n, a[e], t), t && !h[1 ^ e] && rt(n, a[1 ^ e])
                    }), nt(n, "data-svg", this.icon || this.src)
                }
            }
        },
        Si = {};
    ...
    function Ai(t, e) {
        return nt(t, "data-svg") === nt(e, "data-svg")
    }
    var _i = {},
        Ni = {
        ...
        Mi = {
            ...
            methods: {
                getSvg: function() {
                    var t = function(t) {
                        if (!Ni[t]) return null;
                        _i[t] || (_i[t] = Se(Ni[t].trim()));
                        return _i[t].cloneNode(!0)
                    }(function(t) {
                        return at ? q(q(t, "left", "right"), "previous", "next") : t
                    }(this.icon));
                    return t ? ee.resolve(t) : ee.reject("Icon not found.")
                }
            }
        },
        Oi = {
            ...
            beforeConnect: function() {
                Ce(this.$el, this.$name)
            }
        },
        Di = {
            extends: Oi,
            beforeConnect: function() {
                Ce(this.$el, "uk-slidenav")
            },
            computed: {
                icon: function(t, e) {
                    var n = t.icon;
        ...
        zi = {
            ...
            computed: {
                icon: function(t, e) {
                    var n = t.icon;
                    return Me(e, "uk-search-icon") && Mt(e, ".uk-search-large").length ? "search-large" : Mt(e, ".uk-search-navbar").length ? "search-navbar" : n
                }
            }
        },
        Bi = {
    ...
    var Hi = {
        ...
        computed: {
            ...
            target: {
                get: function(t) {
                    var e = t.target;
                    return [this.$el].concat(wt(e, this.$el))
                },
                watch: function() {
                    this.observe()
                }
            ...
            write: function(t) {
                if (this.dataSrcset && 1 !== window.devicePixelRatio) {
                    ...
                    !e.match(/^(auto\s?)+$/) && F(e) !== t.bgSize || (t.bgSize = function(t, e) {
                        var n = vn(ji(e)),
                            i = (t.match(Ri) || []).map(F).sort(function(t, e) {
                                return t - e
                            });
        ...
        methods: {
            load: function(t) {
                ...
                }) && (this._data.image = ae(this.dataSrc, this.dataSrcset, this.sizes).then(function(t) {
                    return Li(e.$el, qi(t), t.srcset, t.sizes), Ui[e.cacheKey] = qi(t), t
                }, Z), this.observer.disconnect())
            },
            observe: function() {
                var e = this;
    ...
    function Li(t, e, n, i) {
        if (Yi(t)) i && (t.sizes = i), n && (t.srcset = n), e && (t.src = e);
            ...
            !b(t.style.backgroundImage, e) && (He(t, "backgroundImage", "url(" + Dt(e) + ")"), Yt(t, qt("load", !1)))
        }
    }
    ...
    var Ki = {
        ...
        computed: {
            matchMedia: function() {
                var t = function(t) {
                    if (O(t)) {
                        if ("@" === t[0]) t = F(We("breakpoint-" + t.substr(1)));
    ...
    var Gi, Ji = {
            ...
            update: {
                ...
                write: function(t) {
                    Oe(this.wrapper, this.clsHide, t.hide), t.changed && (t.changed = !1, nt(this.wrapper, this.attrFill, new Array(t.width).join(t.fill)))
                },
                events: ["resize"]
            }
        },
        ...
        Qi = {
            ...
            events: [{
                ...
                handler: function(t) {
                    var e = Gi && Gi !== this && Gi;
                    Gi = this, e && (this.stack ? this.prev = e : ((Gi = e).hide().then(this.show), t.preventDefault()))
                }
            }, {
                name: "show",
                self: !0,
                handler: function() {
                    var i = this;
                    Me(document.documentElement, this.clsPage) || (this.scrollbarWidth = sn(window) - sn(document), He(document.body, "overflowY", this.scrollbarWidth && this.overlay ? "scroll" : "")), Ce(document.documentElement, this.clsPage), this.bgClose && Rt(this.$el, "hide", ui(document, "click", function(t) {
                        var e = t.defaultPrevented,
                            n = t.target;
                        e || Gi !== i || Gi.overlay && !jt(n, Gi.$el) || jt(n, Gi.panel) || Gi.hide()
                    }), {
                        self: !0
                    }), this.escClose && Rt(this.$el, "hide", Wt(document, "keydown", function(t) {
                        27 === t.keyCode && Gi === i && (t.preventDefault(), Gi.hide())
                    }), {
                        self: !0
                    })
                }
            ...
            methods: {
                ...
                show: function() {
                    var e = this;
                    return this.container && this.$el.parentNode !== this.container ? (fe(this.container, this.$el), new ee(function(t) {
                ...
                hide: function() {
                    return this.toggleElement(this.$el, !1, tr(this))
                },
                getActive: function() {
                    return Gi
                }
    ...
    function tr(t) {
        ...
        return function(r, o) {
            return new ee(function(n, i) {
                return Rt(r, "show hide", function() {
                    r._reject && r._reject(), r._reject = i, a(r, o);
                    var t = Rt(s, "transitionstart", function() {
                            Rt(s, "transitionend transitioncancel", n, {
                                self: !0
                            }), clearTimeout(e)
                        }, {
                            self: !0
    ...
    var er = {
        install: function(a) {
            a.modal.dialog = function(t, e) {
                ...
                return n = U({
                    ...
                    return Wt(a.modal.dialog(' <div class="uk-modal-body">' + (O(e) ? e : de(e)) + '</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-primary uk-modal-close" autofocus>' + n.labels.ok + "</button> </div> ", n).$el, "hide", t)
                })
                ...
                return o = U({
                    ...
                    escClose: !0,
                    labels: a.modal.labels
                }, o), new ee(function(e, t) {
                    var n = a.modal.dialog(' <form> <div class="uk-modal-body">' + (O(r) ? r : de(r)) + '</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-default uk-modal-close" type="button">' + o.labels.cancel + '</button> <button class="uk-button uk-button-primary" autofocus>' + o.labels.ok + "</button> </div> </form> ", o),
                        i = !1;
                    Wt(n.$el, "submit", "form", function(t) {
                        t.preventDefault(), e(), i = !0, n.hide()
                    }), Wt(n.$el, "hide", function() {
                        i || t()
                    })
                })
        ...
        events: [{
            ...
            self: !0,
            handler: function() {
                Me(this.panel, "uk-margin-auto-vertical") ? Ce(this.$el, "uk-flex") : He(this.$el, "display", "block"), on(this.$el)
            }
        }, {
            name: "hidden",
            self: !0,
            handler: function() {
                He(this.$el, "display", ""), Ae(this.$el, "uk-flex")
            }
        }]
    };
    var nr = {
        ...
        ir = {
            ...
            beforeConnect: function() {
                ...
                this.dropbar = t && (vt(t, this.$el) || Se("+ .uk-navbar-dropbar", this.$el) || Se("<div></div>")), this.dropbar && (Ce(this.dropbar, "uk-navbar-dropbar"), "slide" === this.dropbarMode && Ce(this.dropbar, "uk-navbar-dropbar-slide"))
            },
            disconnected: function() {
            ...
            events: [{
                ...
                handler: function(t) {
                    var e = t.current,
                        n = this.getActive();
                    n && n.toggle && !jt(n.toggle.$el, e) && !n.tracker.movesTo(n.$el) && n.hide(!1)
                }
            }, {
                name: "mouseleave",
                el: function() {
                ...
                handler: function(t, e) {
                    var n = e.$el,
                        i = e.dir;
                    this.clsDrop && Ce(n, this.clsDrop + "-dropbar"), "bottom" === i && this.transitionTo(n.offsetHeight + F(He(n, "marginTop")) + F(He(n, "marginBottom")), n)
                }
            }, {
                name: "beforehide",
                filter: function() {
                ...
                handler: function(t, e) {
                    var n = e.$el,
                        i = this.getActive();
                    At(this.dropbar, ":hover") && i && i.$el === n && t.preventDefault()
                }
            }, {
                name: "hide",
                filter: function() {
            ...
            methods: {
                getActive: function() {
                    ...
                    return t && b(t.mode, "hover") && jt(t.toggle.$el, this.$el) && t
                },
                transitionTo: function(t, e) {
                    var n = this,
                        i = this.dropbar,
                        r = Pt(i) ? on(i) : 0;
                    return He(e = r < t && e, "clip", "rect(0," + e.offsetWidth + "px," + r + "px,0)"), on(i, r), Ue.cancel([e, i]), ee.all([Ue.start(i, {
                        height: t
        ...
        rr = {
            ...
            events: [{
                ...
                handler: function(t) {
                    ...
                    !t.defaultPrevented && e && Se(e, document.body) && this.hide()
                }
            }, {
                name: "touchstart",
                passive: !0,
                ...
                self: !0,
                handler: function() {
                    "reveal" !== this.mode || Me(this.panel.parentNode, this.clsMode) || (we(this.panel, "<div>"), Ce(this.panel.parentNode, this.clsMode)), He(document.documentElement, "overflowY", this.overlay ? "hidden" : ""), Ce(document.body, this.clsContainer, this.clsFlip), He(document.body, "touch-action", "pan-y pinch-zoom"), He(this.$el, "display", "block"), Ce(this.$el, this.clsOverlay), Ce(this.panel, this.clsSidebarAnimation, "reveal" !== this.mode ? this.clsMode : ""), on(document.body), Ce(document.body, this.clsContainerAnimation), this.clsContainerAnimation && (or().content += ",user-scalable=0")
                }
            }, {
                name: "hide",
                self: !0,
                handler: function() {
                    Ae(document.body, this.clsContainerAnimation), He(document.body, "touch-action", "");
                    var t = this.getActive();
                    ("none" === this.mode || t && t !== this && t !== this.prev) && Yt(this.panel, "transitionend")
                }
            }, {
                name: "hidden",
                self: !0,
                handler: function() {
                    ...
                    }(), "reveal" === this.mode && ye(this.panel), Ae(this.panel, this.clsSidebarAnimation, this.clsMode), Ae(this.$el, this.clsOverlay), He(this.$el, "display", ""), Ae(document.body, this.clsContainer, this.clsFlip), He(document.documentElement, "overflowY", "")
                }
            }, {
    ...
    var sr = {
            ...
            update: {
                read: function() {
                    return !(!this.content || !this.container) && {
                        current: F(He(this.$el, "maxHeight")),
                ...
                write: function(t) {
                    var e = t.current,
                        n = t.max;
                    He(this.$el, "maxHeight", n), Math.round(e) !== Math.round(n) && Yt(this.$el, "resize")
                },
                events: ["resize"]
            }
        },
        ar = {
            props: ["width", "height"],
            connected: function() {
                Ce(this.$el, "uk-responsive-width")
            },
            update: {
                read: function() {
                    return !!(Pt(this.$el) && this.width && this.height) && {
                        width: sn(this.$el.parentNode),
                        height: this.height
                    }
                },
                write: function(t) {
                    on(this.$el, et.contain({
                        height: this.height,
                        width: this.width
                    }, t).height)
                },
        ...
        hr = {
            ...
            methods: {
                scrollTo: function(e) {
                    ...
                    if (t < r + i && (r = t - i), Yt(this.$el, "beforescroll", [this, e])) {
                        var o = Date.now(),
                            s = window.pageYOffset,
                            a = function() {
                                var t = s + (r - s) * function(t) {
                                    return .5 * (1 - Math.cos(Math.PI * t))
                                }(J((Date.now() - o) / n.duration));
                                mn(window, t), t !== r ? requestAnimationFrame(a) : Yt(n.$el, "scrolled", [n, e])
                            };
                        a()
                    }
                }
            ...
            events: {
                click: function(t) {
                    t.defaultPrevented || (t.preventDefault(), this.scrollTo(Dt(decodeURIComponent(this.$el.hash)).substr(1)))
                }
            }
        };
    var cr = {
            ...
            update: [{
                write: function() {
                    this.hidden && He(Ft(this.elements, ":not(." + this.inViewClass + ")"), "visibility", "hidden")
                }
            }, {
                read: function(t) {
                    var n = this;
                    t.update && this.elements.forEach(function(t) {
                        ...
                        (e = e || {
                            cls: ot(t, "uk-scrollspy-class") || n.cls
                    ...
                    this.elements.forEach(function(t) {
                        ...
                        if (!n.show || n.inview || n.queued) {
                            if (!n.show && (n.inview || n.queued) && o.repeat) {
                                ...
                                He(t, "visibility", o.hidden ? "hidden" : ""), Ae(t, o.inViewClass), Oe(t, e), Yt(t, "outview"), o.$update(t), n.inview = !1
                            }
                        } else {
                            var i = function() {
                                He(t, "visibility", ""), Ce(t, o.inViewClass), Oe(t, e), Yt(t, "inview"), o.$update(t), n.inview = !0, n.abort && n.abort()
                            };
                            o.delay ? (n.queued = !0, r.promise = (r.promise || ee.resolve()).then(function() {
                                return !n.inview && new ee(function(t) {
            ...
            update: [{
                ...
                read: function(o) {
                    ...
                    o.active = !1, this.targets.every(function(t, e) {
                        ...
                        return !(o.active = Se(Ft(s.links, '[href="#' + t.id + '"]')))
                    })
                },
                write: function(t) {
                    var e = t.active;
                    this.links.forEach(function(t) {
                        return t.blur()
                    }), Ae(this.elements, this.cls), e && Yt(this.$el, "active", [e, Ce(this.closest ? Nt(e, this.closest) : e, this.cls)])
                },
                events: ["scroll", "resize"]
            }]
        },
        lr = {
            ...
            computed: {
                ...
                isActive: {
                    ...
                    set: function(t) {
                        t && !this.isActive ? (Ne(this.selTarget, this.clsInactive, this.clsActive), Yt(this.$el, "active")) : t || Me(this.selTarget, this.clsInactive) || (Ne(this.selTarget, this.clsActive, this.clsInactive), Yt(this.$el, "inactive"))
                    }
                }
            },
            connected: function() {
            ...
            disconnected: function() {
                this.isFixed && (this.hide(), Ae(this.selTarget, this.clsInactive)), ve(this.placeholder), this.placeholder = null, this.widthElement = null
            },
            events: [{
            ...
            update: [{
                read: function(t, e) {
                    ...
                    return this.top = Math.max(F(dr("top", this)), this.topOffset) - this.offset, this.bottom = i && i - n, this.inactive = !this.matchMedia, {
                        lastScroll: !1,
                        height: n,
                ...
                write: function(t) {
                    ...
                    He(i, U({
                        height: e
                    }, n)), jt(i, document) || (me(this.$el, i), nt(i, "hidden", "")), this.isActive = this.isActive
                },
                events: ["resize"]
            }, {
                read: function(t) {
                    var e = t.scroll;
                    return void 0 === e && (e = 0), this.width = (Pt(this.widthElement) ? this.widthElement : this.$el).offsetWidth, this.scroll = window.pageYOffset, {
                ...
                write: function(t, e) {
                    ...
                    if (!((t.lastScroll = a) < 0 || a === s || !c || this.disabled || this.showOnUp && "scroll" !== e || ((300 < u - i || r !== o) && (t.initScroll = a, t.initTimestamp = u), t.lastDir = r, this.showOnUp && Math.abs(t.initScroll - a) <= 30 && Math.abs(s - a) <= 10)))
                        ...
                        } else this.isFixed ? this.update() : this.animation ? (Ze.cancel(this.$el), this.show(), Ze.in(this.$el, this.animation).catch(Z)) : this.show()
                },
                events: ["resize", "scroll"]
            }],
            methods: {
                show: function() {
                    this.isFixed = !0, this.update(), nt(this.placeholder, "hidden", null)
                },
                hide: function() {
                    this.isActive = !1, Ae(this.$el, this.clsFixed, this.clsBelow), He(this.$el, {
                        position: "",
                        top: "",
                        width: ""
                ...
                update: function() {
                    ...
                    this.bottom && this.scroll > this.bottom - this.offset && (e = this.bottom - this.scroll), He(this.$el, {
                        ...
                        top: e + "px",
                        width: this.width
                    }), this.isActive = t, Oe(this.$el, this.clsBelow, this.scroll > this.bottomOffset), Ce(this.$el, this.clsFixed)
                }
            }
        };
    ...
    function dr(t, e) {
        var n = e.$props,
            ...
            r = e[t + "Offset"],
            o = n[t];
        if (o) return z(o) && O(o) && o.match(/^-?\d/) ? r + vn(o) : en(!0 === o ? i.parentNode : vt(o, i)).bottom
    }
    var fr, pr = {
            mixins: [ei],
            args: "connect",
            ...
            events: [{
                ...
                handler: function(e) {
                    e.preventDefault(), this.show(W(this.$el.children).filter(function(t) {
                        return jt(e.current, t)
                    })[0])
                }
            }, {
                name: "click",
            ...
            update: function() {
                ...
                this.show(Ft(t, "." + this.cls)[0] || t[this.active] || t[0]), this.swiping && He(this.connects, "touch-action", "pan-y pinch-zoom")
            },
            methods: {
                index: function() {
                    return !B(this.connects) && ce(Ft(this.connects[0].children, "." + this.cls)[0])
                },
                show: function(t) {
                    for (var e, n, i = this, r = this.$el.children, o = r.length, s = this.index(), a = 0 <= s, h = "previous" === t ? -1 : 1, c = ue(t, r, s), u = 0; u < o; u++, c = (c + h + o) % o)
                        if (!At(this.toggles[c], ".uk-disabled *, .uk-disabled, [disabled]")) {
                            e = this.toggles[c], n = r[c];
                            break
                        }!n || 0 <= s && Me(n, this.cls) || s === c || (Ae(r, this.cls), Ce(n, this.cls), nt(this.toggles, "aria-expanded", !1), nt(e, "aria-expanded", !0), this.connects.forEach(function(t) {
        ...
        gr = {
            ...
            events: [{
                ...
                handler: function(t) {
                    Zt(t) || this.toggle("toggle" + (t.type === pt ? "show" : "hide"))
                }
            }, {
                name: "click",
                filter: function() {
                    return b(this.mode, "click") || ut && b(this.mode, "hover")
                },
                handler: function(t) {
                    var e;
                    (Nt(t.target, 'a[href="#"], a[href=""]') || (e = Nt(t.target, "a[href]")) && (this.cls || !Pt(this.target) || e.hash && At(this.target, e.hash))) && t.preventDefault(), this.toggle()
                }
            }],
            update: {
                read: function() {
            ...
            methods: {
                animate: function(t) {
                    ...
                    var s = on(this.target),
                        a = (r = r.concat(W(this.target.children).filter(function(t) {
                            return !b(r, t)
                        }))).map(function(t, e) {
                            return !!(t.parentNode && e in o) && (o[e] ? Pt(t) ? $r(t) : {
                                opacity: 0
                            } : {
                                opacity: Pt(t) ? 1 : 0
                            })
                    ...
                    return o = a.map(function(t, e) {
                        ...
                        return n
                    }), Ce(this.target, br), r.forEach(function(t, e) {
                        return o[e] && He(t, o[e])
                    }), He(this.target, "height", e), mn(window, n), ee.all(r.map(function(t, e) {
                        return o[e] && a[e] ? Ue.start(t, a[e], i.animation, "ease") : ee.resolve()
        ...
        methods: {
            ...
            setState: function(o, t) {
                ...
                void 0 === t && (t = !0), o = U({
                    ...
                    sort: []
                }, o), Yt(this.$el, "beforeFilter", [this, o]);
                var a = this.children;
                this.toggles.forEach(function(t) {
                ...
                function e() {
                    ...
                    a.forEach(function(t) {
                        return He(t, "display", e && !At(t, e) ? "none" : "")
                    });
                    var t = o.sort,
                        n = t[0],
                        i = t[1];
                    if (n) {
                        var r = function(t, n, i) {
                            return U([], t).sort(function(t, e) {
                                return ot(t, n).localeCompare(ot(e, n), void 0, {
                                    numeric: !0
                                }) * ("asc" === i || -1)
                            })
                        }(a, n, i);
                        Y(r, a) || r.forEach(function(t) {
                            return fe(s.target, t)
                        })
                    }
                }
                t ? this.animate(e).then(function() {
                    return Yt(s.$el, "afterFilter", [s])
                }) : (e(), Yt(this.$el, "afterFilter", [this]))
            },
    ...
    function Tr(t, e, n) {
        var i = Sr(t, e),
            ...
            s = i.sort,
            a = i.order;
        return void 0 === a && (a = "asc"), (r || P(s)) && (o ? r ? (delete n.filter[""], n.filter[o] = r) : (delete n.filter[o], (B(n.filter) || "" in n.filter) && (n.filter = {
            "": r || ""
        })) : n.filter = {
            "": r || ""
        }), P(s) || (n.sort = [s, a]), n
    ...
    var Er = {
        slide: {
            ...
            translate: function(t, e) {
                return [{
                    transform: Ar(-100 * e * t)
                }, {
                    transform: Ar(100 * e * (1 - t))
                }]
            }
        }
    };
    ...
    function Ar(t, e) {
        return void 0 === t && (t = 0), void 0 === e && (e = "%"), t += t ? e : "", st ? "translateX(" + t + ")" : "translate3d(" + t + ", 0, 0)"
    }
    ...
    var Or = {
        mixins: [{
            ...
            methods: {
                startAutoplay: function() {
                    ...
                    this.stopAutoplay(), this.interval = setInterval(function() {
                        return (!t.draggable || !Se(":focus", t.$el)) && (!t.pauseOnHover || !At(t.$el, ":hover")) && !t.stack.length && t.show("next")
            ...
            events: [{
                ...
                handler: function(t) {
                    !this.draggable || !Zt(t) && function(t) {
            ...
            methods: {
                start: function() {
                    ...
                    var e = "touchmove" != dt ? Wt(document, dt, this.move, {
                        passive: !1
                    }) : Z;
                    this.unbindMove = function() {
                        e(), t.unbindMove = null
                    }, Wt(window, "scroll", this.unbindMove), Wt(document, ft, this.end, !0), He(this.list, "userSelect", "none")
                },
                move: function(t) {
                    var e = this;
                    if (this.unbindMove) {
                        ...
                        if (!(0 == n || this.prevPos === this.pos || !this.dragging && Math.abs(n) < this.threshold)) {
                            ...
                            [this.index, this.prevIndex].filter(function(t) {
                                ...
                                Yt(i[t], "itemhidden", [e]), d && (h = !0, e.prevIndex = r)
                            }), (this.index === r && this.prevIndex !== r || h) && Yt(i[this.index], "itemshown", [this]), l && (this.prevIndex = r, this.index = s, d || Yt(c, "beforeitemhide", [this]), Yt(u, "beforeitemshow", [this])), this._transitioner = this._translate(Math.abs(this.percent), c, !d && u), l && (d || Yt(c, "itemhide", [this]), Yt(u, "itemshow", [this]))
                        }
                    }
                },
                end: function() {
                    if (Vt(window, "scroll", this.unbindMove), this.unbindMove && this.unbindMove(), Vt(document, ft, this.end, !0), this.dragging)
                        if (this.dragging = null, this.index === this.prevIndex) this.percent = 1 - this.percent, this.dir *= -1, this._show(!1, this.index, !0), this._transitioner = null;
                        else {
                            var t = (at ? this.dir * (at ? 1 : -1) : this.dir) < 0 == this.prevPos > this.pos;
            ...
            methods: {
                updateNav: function() {
                    ...
                    this.navItems.forEach(function(t) {
                        var e = ot(t, n.attrItem);
                        Oe(t, n.clsActive, L(e) === i), Oe(t, "uk-invisible", n.finite && ("previous" === e && 0 === i || "next" === e && i >= n.maxIndex))
                    })
                }
            }
        }],
        ...
        methods: {
                    ...
                    if (i[e ? "unshift" : "push"](t), !e && 1 < i.length) 2 === i.length && this._transitioner.forward(Math.min(this.duration, 200));
                        ...
                        if (a !== c) {
                            if (this.dir = function(t, e) {
                                ...
                                }(t, s), this.prevIndex = s, this.index = h, a && Yt(a, "beforeitemhide", [this]), !Yt(c, "beforeitemshow", [this, a])) return this.index = this.prevIndex, void o();
                            var u = this._show(a, c, e).then(function() {
                                return a && Yt(a, "itemhidden", [n]), Yt(c, "itemshown", [n]), new ee(function(t) {
                                    xn.write(function() {
                                        i.shift(), i.length ? n.show(i.shift(), !0) : n._transitioner = null, t()
                                    })
                                })
                            });
                            return a && Yt(a, "itemhide", [this]), Yt(c, "itemshow", [this]), u
                        }
                        o()
                    }
                }
            ...
            getIndex: function(t, e) {
                return void 0 === t && (t = this.index), void 0 === e && (e = this.index), J(ue(t, this.slides, e, this.finite), 0, this.maxIndex)
            },
            ...
            _show: function(t, e, n) {
                if (this._transitioner = this._getTransitioner(t, e, this.dir, U({
                    ...
                    }, this.transitionOptions)), !n && !t) return this._transitioner.translate(1), ee.resolve();
            ...
            _getTransitioner: function(t, e, n, i) {
                return void 0 === t && (t = this.prevIndex), void 0 === e && (e = this.index), void 0 === n && (n = this.dir || 1), void 0 === i && (i = this.transitionOptions), new this.Transitioner(D(t) ? this.slides[t] : t, D(e) ? this.slides[e] : e, n * (at ? -1 : 1), i)
            }
        }
    };
    ...
    var zr = {
                ...
                Transitioner: function(o, s, a, t) {
                    ...
                    return {
                        ...
                        show: function(t, e, n) {
                            ...
                            void 0 === e && (e = 0);
                            var r = n ? "linear" : h;
                            return t -= Math.round(t * J(e, -1, 1)), this.translate(e), Mr(s, "itemin", {
                                percent: e,
                                duration: t,
                                timing: r,
                                dir: a
                                ...
                                timing: r,
                                dir: a
                            }), ee.all([Ue.start(s, c[1], t, r), Ue.start(o, c[0], t, r)]).then(function() {
                                i.reset(), u.resolve()
                            }, Z), u.promise
                        },
                        stop: function() {
        ...
        Br = {
            ...
            events: [{
                ...
                self: !0,
                handler: function() {
                    this.hideControls(), Ae(this.slides, this.clsActive), Ue.stop(this.slides)
                }
            }, {
                name: "hidden",
                self: !0,
                ...
                name: "beforeitemshow",
                handler: function(t) {
                    this.isToggled() || (this.draggable = !1, t.preventDefault(), this.toggleNow(this.$el, !0), this.animation = Nr.scale, Ae(t.target, this.clsActive), this.stack.splice(1, 0, this.index))
                }
            }, {
                name: "itemshow",
                handler: function(t) {
                ...
                handler: function(t, r) {
                    ...
                    if (this.setItem(r, "<span uk-spinner></span>"), e)
                        if ("image" === n || e.match(/\.(jp(e)?g|png|gif|svg|webp)($|\?)/i)) ae(e).then(function(t) {
                        ...
                        nt(a, "src", e), Rt(a, "error loadedmetadata", function(t) {
                            "error" === t ? s.setError(r) : (nt(a, {
                                width: a.videoWidth,
                        ...
                        ae("https://img.youtube.com/vi/" + h + "/maxresdefault.jpg").then(function(t) {
                            var e = t.width,
                                n = t.height;
                            120 === e && 90 === n ? ae("https://img.youtube.com/vi/" + h + "/0.jpg").then(function(t) {
                                var e = t.width,
                                    n = t.height;
                                return c(e, n)
                            }, c) : c(e, n)
                        }, c)
                    } else(o = e.match(/(\/\/.*?)vimeo\.[a-z]+\/([0-9]+).*?/)) && se("https://vimeo.com/api/oembed.json?maxwidth=1920&url=" + encodeURI(e), {
                        responseType: "json",
                        withCredentials: !1
                    }).then(function(t) {
                        var e = t.response,
            ...
            methods: {
                ...
                setItem: function(t, e) {
                    ...
                    Yt(this.$el, "itemloaded", [this, n]), this.$update(n)
                },
                setError: function(t) {
                    this.setItem(t, '<span uk-icon="icon: bolt; ratio: 2"></span>')
                },
                showControls: function() {
                    clearTimeout(this.controlsTimer), this.controlsTimer = setTimeout(this.hideControls, this.delayControls), Ce(this.$el, "uk-active", "uk-transition-active")
                },
    ...
    var Hr, Lr = {
        ...
        computed: {
            ...
            items: function() {
                return G(this.toggles.map(Fr), "source")
            }
        },
        disconnected: function() {
            this.hide()
        ...
        events: [{
            ...
            handler: function(t) {
                t.preventDefault();
                var e = ot(t.current, "href");
                this.show(x(this.items, function(t) {
                    return t.source === e
                }))
            }
        }],
    ...
    function Fr(n) {
        return ["href", "caption", "type", "poster", "alt"].reduce(function(t, e) {
            return t["href" === e ? "source" : e] = ot(n, e), t
        }, {})
    }
    var jr = {},
        Wr = {
            ...
            connected: function() {
                var t, e = this,
                    n = F(He(this.$el, this.marginProp));
            ...
            methods: {
                close: function(t) {
                    function e() {
                        Yt(n.$el, "close", [n]), ve(n.$el), jr[n.pos].children.length || He(jr[n.pos], "display", "none")
                    }
                    var n = this;
                ...
                props: function(m, g) {
                    ...
                    return Vr.reduce(function(t, e) {
                        ...
                        if (o) {
                            ...
                            a = a.map(function(t) {
                                return function(t, e) {
                                    return He(He(t, "color", e), "color").split(/[(),]/g).slice(1, -1).concat(1).slice(0, 4).map(F)
                                }(g, t)
                            }), g.style.color = c
                        } else if (w(e, "bg")) {
                        ...
                        switch (e) {
                            ...
                            case "borderColor":
                                ...
                                t[e] = "rgba(" + h.map(function(t, e) {
                                    return t += u * (c[e] - t), 3 === e ? F(t) : parseInt(t, 10)
                                }).join(",") + ")";
                                break;
                            case "blur":
    ...
    function Jr(t, e) {
        return (rn(t).left + (at ? Zr(t).width - Zr(e).width : 0)) * (at ? -1 : 1)
    }
    ...
    var eo = {
            ...
            data: {
                ...
                Transitioner: function(r, i, o, t) {
                    var e = t.center,
                        ...
                        c = i ? Xr(i, a, e) : n + Zr(r).width * o * (at ? -1 : 1);
                    return {
                        dir: o,
                        show: function(t, e, n) {
                            void 0 === e && (e = 0);
                            var i = n ? "linear" : s;
                            return t -= Math.round(t * J(e, -1, 1)), this.translate(e), r && this.updateTranslates(), e = r ? e : J(e, 0, 1), Qr(this.getItemIn(), "itemin", {
                                percent: e,
                                duration: t,
                                timing: i,
                                dir: o
                                ...
                                transform: Ar(-c * (at ? -1 : 1), "px")
                            }, t, i).then(h.resolve, Z), h.promise
                        },
                        stop: function() {
                            return Ue.stop(a)
                        },
                        ...
                        translate: function(t) {
                            var e = this.getDistance() * o * (at ? -1 : 1);
                            He(a, "transform", Ar(J(e - e * t - c, -Gr(a), Zr(a).width) * (at ? -1 : 1), "px")), this.updateTranslates(), r && (t = J(t, -1, 1), Qr(this.getItemIn(), "itemtranslatein", {
                                percent: t,
                                dir: o
                        ...
                        percent: function() {
                            return Math.abs((He(a, "transform").split(",")[4] * (at ? -1 : 1) + n) / (c - n))
                        },
                        getDistance: function() {
                            return Math.abs(c - n)
                        },
                        ...
                        getActives: function() {
                            var n = Xr(r || i, a, e);
                            return K(to(a).filter(function(t) {
                                var e = Jr(t, a);
            ...
            update: {
                write: function() {
                    ...
                    Te("[" + this.attrItem + "],[data-" + this.attrItem + "]", this.$el).forEach(function(t) {
                        var e = ot(t, n.attrItem);
                        n.maxIndex && Oe(t, "uk-hidden", z(e) && (n.sets && !b(n.sets, F(e)) || e > n.maxIndex))
            ...
            events: {
                ...
                itemshow: function() {
                    P(this.prevIndex) || Ce(this._getTransitioner().getItemIn(), this.clsActive)
                },
                itemshown: function() {
                    var e = this,
                        n = this._getTransitioner(this.index).getActives();
                    this.slides.forEach(function(t) {
                        return Oe(t, e.clsActive, b(n, t))
                    }), this.sets && !b(this.sets, F(this.index)) || this.slides.forEach(function(t) {
                        return Oe(t, e.clsActivated, b(n, t))
                    })
                }
            },
            methods: {
            ...
            events: [{
                ...
                handler: function(t) {
                    var e = t.type,
                        ...
                        o = n.timing,
                        s = n.dir;
                    Ue.cancel(this.$el), He(this.$el, this.getCss(ro(e, s, i))), Ue.start(this.$el, this.getCss(io(e) ? .5 : 0 < s ? 1 : 0), r, o).catch(Z)
                }
            }, {
    ...
    var oo, so = U({}, Er, {
        ...
        ho = {
            ...
            update: {
                write: function() {
                    if (this.clsEmpty && Oe(this.$el, this.clsEmpty, B(this.$el.children)), He(this.handle ? Te(this.handle, this.$el) : this.$el.children, {
                            touchAction: "none",
                            userSelect: "none"
                        }), this.drag) {
                        var t = en(window),
                            ...
                            n = t.bottom;
                        en(this.drag, {
                                top: J(this.pos.y + this.origin.top, 0, n - this.drag.offsetHeight),
                                left: J(this.pos.x + this.origin.left, 0, e - this.drag.offsetWidth)
                            }),
                            function s(t) {
                                var a = t.x;
                                var h = t.y;
                                clearTimeout(oo);
                                (e = document.elementFromPoint(a - window.pageXOffset, h - window.pageYOffset), n = lo(), function(t, e) {
                                    var n = [];
                                    for (; e(t) && n.unshift(t), t = t && t.parentElement;);
                                    return n
                                }(e, function(t) {
                                    return t === n || uo.test(He(t, "overflow"))
                                })).some(function(t) {
                                    var e = t.scrollTop,
                                        n = t.scrollHeight;
                                    lo() === t && (t = window, n -= window.innerHeight);
                                    var i = en(t),
                                        r = i.top,
                                        o = i.bottom;
                                    if (r < h && h < r + 30 ? e -= 5 : h < o && o - 20 < h && (e += 5), 0 < e && e < n) return oo = setTimeout(function() {
                                        mn(t, e), s({
                                            x: a,
                                            y: h
                                        })
            ...
            methods: {
                init: function(t) {
                    ...
                    !r || i || 0 < n || Lt(e) || jt(e, "." + this.clsNoDrag) || this.handle && !jt(e, this.handle) || (t.preventDefault(), this.touched = [this], this.placeholder = r, this.origin = U({
                        target: e,
                        index: ce(r)
                    }, this.pos), Wt(document, dt, this.move), Wt(document, ft, this.end), Wt(window, "scroll", this.scroll), this.threshold || this.start(t))
                },
                start: function(t) {
                    this.drag = fe(this.$container, this.placeholder.outerHTML.replace(/^<li/i, "<div").replace(/li>$/i, "div>")), He(this.drag, U({
                        boxSizing: "border-box",
                        width: this.placeholder.offsetWidth,
                        height: this.placeholder.offsetHeight,
                        overflow: "hidden"
                    }, He(this.placeholder, ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom"]))), nt(this.drag, "uk-no-boot", ""), Ce(this.drag, this.clsDrag, this.clsCustom), on(this.drag.firstElementChild, on(this.placeholder.firstElementChild));
                    ...
                    U(this.origin, {
                        left: n - this.pos.x,
                        top: i - this.pos.y
                    }), Ce(this.placeholder, this.clsPlaceholder), Ce(this.$el.children, this.clsItem), Ce(document.documentElement, this.clsDragState), Yt(this.$el, "start", [this, this.placeholder]), this.move(t)
                },
                move: function(t) {
                    if (this.drag) {
                        this.$emit();
                        var e = "mousemove" === t.type ? t.target : document.elementFromPoint(this.pos.x - window.pageXOffset, this.pos.y - window.pageYOffset),
                            ...
                            r = n !== i;
                        if (n && !jt(e, this.placeholder) && (!r || n.group && n.group === i.group)) {
                            if (e = n.$el === e.parentNode && e || W(n.$el.children).filter(function(t) {
                                    return jt(e, t)
                    ...
                    if (Vt(document, dt, this.move), Vt(document, ft, this.end), Vt(window, "scroll", this.scroll), this.drag) {
                        clearTimeout(oo);
                        var e = this.getSortable(this.placeholder);
                        this === e ? this.origin.index !== ce(this.placeholder) && Yt(this.$el, "moved", [this, this.placeholder]) : (Yt(e.$el, "added", [e, this.placeholder]), Yt(this.$el, "removed", [this, this.placeholder])), Yt(this.$el, "stop", [this, this.placeholder]), ve(this.drag), this.drag = null;
                        var n = this.touched.map(function(t) {
                            return t.clsPlaceholder + " " + t.clsItem
                        }).join(" ");
                        this.touched.forEach(function(t) {
                            return Ae(t.$el.children, n)
                ...
                insert: function(t, e) {
                    var n = this;
                    Ce(this.$el.children, this.clsItem);

                    function i() {
                        e ? !jt(t, n.$el) || function(t, e) {
                ...
                remove: function(t) {
                    jt(t, this.$el) && (He(this.handle ? Te(this.handle, t) : t, {
                        touchAction: "",
                        userSelect: ""
    ...
    var fo, po, mo, go = [],
        vo = {
            ...
            beforeConnect: function() {
                this._hasTitle = it(this.$el, "title"), nt(this.$el, {
                    title: "",
                    "aria-expanded": !1
                })
            },
            disconnected: function() {
                this.hide(), nt(this.$el, {
            ...
            methods: {
                show: function() {
                    ...
                    !this.isActive() && this.title && (go.forEach(function(t) {
                        return t.hide()
                    }), go.push(this), this._unbind = Wt(document, ft, function(t) {
                        return !jt(t.target, e.$el) && e.hide()
                ...
                hide: function() {
                    this.isActive() && !At(this.$el, "input:focus") && (go.splice(go.indexOf(this), 1), clearTimeout(this.showTimer), clearInterval(this.hideTimer), nt(this.$el, "aria-expanded", !1), this.toggleElement(this.tooltip, !1), this.tooltip && ve(this.tooltip), this.tooltip = !1, this._unbind())
                },
                _show: function() {
            ...
            events: (co = {
                ...
                Zt(t) || (t.type === pt ? this.show() : this.hide())
            }, co[lt] = function(t) {
                Zt(t) && (this.isActive() ? this.hide() : this.show())
            }, co)
        },
        wo = {
            props: {
            ...
            events: {
                ...
                drop: function(t) {
                    ...
                    e && e.files && (Ae(this.$el, this.clsDragover), this.upload(e.files))
                },
                dragenter: function(t) {
                    yo(t)
                },
                dragover: function(t) {
                    yo(t), Ce(this.$el, this.clsDragover)
                },
                dragleave: function(t) {
                    yo(t), Ae(this.$el, this.clsDragover)
                }
            },
            methods: {
                upload: function(t) {
                            ...
                            o = function(t) {
                                ...
                                se(i.url, {
                                    ...
                                    beforeSend: function(t) {
                                        var e = t.xhr;
                                        e.upload && Wt(e.upload, "progress", i.progress), ["loadStart", "load", "loadEnd", "abort"].forEach(function(t) {
                                            return Wt(e, t.toLowerCase(), i[t])
                                        }), i.beforeSend(t)
                                    }
                                }).then(function(t) {
    ...
    function xo() {
        $o(document.body, po), xn.flush(), new MutationObserver(function(t) {
            return t.forEach(ko)
        }).observe(document, {
            childList: !0,
            subtree: !0,
    ...
    function ko(t) {
        ...
        ("attributes" !== t.type ? function(t) {
            for (var e = t.addedNodes, n = t.removedNodes, i = 0; i < e.length; i++) $o(e[i], po);
            for (var r = 0; r < n.length; r++) $o(n[r], mo);
            return !0
        }(t) : function(t) {
            var e = t.target,
                n = t.attributeName;
            ...
            var i = Pn(n);
            if (!(i && i in fo)) return;
            if (it(e, n)) return fo[i](e), !0;
            var r = fo.getComponent(e, i);
